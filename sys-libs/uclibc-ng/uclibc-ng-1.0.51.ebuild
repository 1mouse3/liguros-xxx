...
PATCH_VER=""
SRC_URI="https://downloads.uclibc-ng.org/releases/${PV}/${MY_P}.tar.xz"
SRC_URI="https://downloads.uclibc-ng.org/releases/${PV}/${MY_P}.tar.xz.asc"

### SHA256: 3484c8c7a0503c08f7e5fa7473c987414050726f31e8593d02d984f512d1a0cb ### needs set for GPG signature ###
